...
async function getStaticPaths({ paginate }) {
  ...
  const paths = countries.map((country) => {
    const countryProducts = allProducts.filter((product) => {
      const pCountry = product.data.properties.pCountry;
...
}, "/workspace/src/pages/products/[country]/[...page].astro", void 0);

const $$file = "/workspace/src/pages/products/[country]/[...page].astro";
const $$url = "/products/[country]/[...page]";
